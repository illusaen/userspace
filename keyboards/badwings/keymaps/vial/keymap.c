...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [DEF] = LAYOUT_split_3x5_3(KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_QUOT, KC_LSFT, KC_SPC, LA_NAV, LA_SYM, KC_SPC, KC_BSPC),

    [COL] = LAYOUT_split_3x5_3(KC_Q, KC_W, KC_F, KC_P, KC_B, KC_J, KC_L, KC_U, KC_Y, KC_QUOT, KC_A, KC_S, KC_D, KC_F, KC_G, KC_M, KC_N, KC_E, KC_I, KC_O, KC_Z, KC_X, KC_C, KC_D, KC_V, KC_K, KC_H, KC_COMM, KC_DOT, KC_SCLN, KC_LSFT, KC_SPC, LA_NAV, LA_SYM, KC_SPC, KC_BSPC),

    [NAV] = LAYOUT_split_3x5_3(KC_ESC, X_WORD, SELWORD, KC_TAB, NUM_WD, SW_WIN, KC_HOME, KC_UP, KC_END, KC_DEL, OS_ALT, OS_SHFT, OS_CMD, OS_CTRL, CAPS_WD, RUN, KC_LEFT, KC_DOWN, KC_RGHT, KC_ENT, LA_NUM, CUT, COPY, PASTE, UNDO, REDO, LWORD, COMMENT, RWORD, COMMENT, _______, _______, _______, _______, _______, _______),

    [SYM] = LAYOUT_split_3x5_3(KC_TILD, KC_LBRC, KC_LCBR, KC_LPRN, KC_EXLM, KC_AMPR, KC_RPRN, KC_RCBR, KC_RBRC, KC_GRV, KC_MINS, KC_PIPE, KC_SLSH, KC_EQL, KC_DLR, KC_HASH, OS_CTRL, OS_CMD, OS_SHFT, OS_ALT, KC_BSLS, ARROWTN, ARROWFT, KC_UNDS, KC_QUES, KC_AT, KC_COLN, KC_LT, KC_GT, DBLCOLN, _______, _______, _______, _______, _______, _______),

    [NUM] = LAYOUT_split_3x5_3(KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, OS_ALT, OS_SHFT, OS_CMD, OS_CTRL, KC_EQL, KC_SLSH, KC_MINS, KC_PLUS, KC_PAST, KC_BSPC, OS_MAC, KC_VOLD, KC_MUTE, KC_VOLU, XXXXXXX, XXXXXXX, KC_DOT, XXXXXXX, XXXXXXX, RESET, _______, _______, _______, _______, _______, _______),
};
